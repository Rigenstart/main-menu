...
printf "\n"
				  ...
				  echo -e "${RED} WHASTAPPS 6282271426251 ${STD}"				    
printf  "\n"

	echo -e "${YELLOW}[${WHITE}0${YELLOW}] ${BLUE}  Keluar dari aplikasi${STD}"
	echo -e "${YELLOW}[${WHITE}1${YELLOW}] ${BLUE} Informasi dan Ringkasan Server${STD}"
	echo -e "${YELLOW}[${WHITE}2${YELLOW}] ${BLUE} Ping ke IP server || Validasi RBL${STD}"
	echo -e "${YELLOW}[${WHITE}3${YELLOW}] ${BLUE} Buat ruang disk server${STD}"
	echo -e "${YELLOW}[${WHITE}4${YELLOW}] ${BLUE} Hentikan pelaku spam || hapus ANTRIAN email || Aktifkan SpamAssassin${STD}"
	echo -e "${YELLOW}[${WHITE}5${YELLOW}] ${BLUE} Instalar let's encryt${STD}"
	echo -e "${YELLOW}[${WHITE}6${YELLOW}] ${BLUE} Tetapkan TANGGAL/WAKTU || Aktifkan NTPD ${STD}"
	echo -e "${YELLOW}[${WHITE}7${YELLOW}] ${BLUE} NGINX sebagai proksi terbalik (DirectAdmin)${STD}"
	echo -e "${YELLOW}[${WHITE}8${YELLOW}] ${BLUE} Bersihkan Seluruh ANTRIAN Email${STD}"
	...
	echo -e "${YELLOW}[${WHITE}12${YELLOW}] ${BLUE} Installisasi cPanel License Server Instan${STD}"
	...
	echo -e "${YELLOW}[${WHITE}16${YELLOW}] ${BLUE} Hitung Ulang Kuota Pengguna di Directadmin${STD}"
	echo -e "${YELLOW}[${WHITE}17${YELLOW}] ${BLUE} PERBAIKI - Kesalahan Berkeley DB: /var/spool/exim/db/callout di EXIM${STD}"
	echo -e "${YELLOW}[${WHITE}18${YELLOW}] ${BLUE} Instal DIRECTADMIN | WHM/CPANEL (Server Bersih)${STD}"
	echo -e "${YELLOW}[${WHITE}19${YELLOW}] ${BLUE} Menguji email dengan SWAKS.${STD}"
	echo -e "${YELLOW}[${WHITE}20${YELLOW}] ${BLUE} STABILISASI Server Penuh.${STD}"
	echo -e "${YELLOW}[${WHITE}21${YELLOW}] ${BLUE} OPTIMALKAN Server Lengkap.${STD}"
	echo -e "${YELLOW}[${WHITE}22${YELLOW}] ${BLUE} PERBARUI Server Penuh.${STD}"
	printf "\n"
	echo -e "${GREEN}----------------------------------------------------------------------------------------------${STD}"
	printf "\n"
}
